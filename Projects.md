...
<img src="https:\\IvyPokorny.github.io\pictures\cs330\CS330B.png" alt="" width="500" height="500" style="border:3px solid black">
<img src="https:\\IvyPokorny.github.io\pictures\cs330\CS330C.png" alt="" width="800" height="300" style="border:3px solid black">
<img src="https:\\IvyPokorny.github.io\pictures\cs330\CS330Cc.png" alt="" width="800" height="500" style="border:3px solid black">
...
<h4> Objective: </h4>
<p> Develop interface software that controls hardware components, analyze hardware architecture design impacts on application performance, and recommend emerging systems architectures based on business needs. </p>
...
<ul>
    <Li> Data Table: Lists animals with details such as breed, sex, and age. </li>
    <li> Filtering Options: Allows users to filter data by various rescue types (e.g., Water Rescue, Mountain Rescue). </li>
    <li> Pie Chart Visualization: Displays the distribution of preferred animal breeds based on user selections. </li>
    <li> Interactive Map: Shows the locations of selected animals, providing a geographical context. </li>
</ul>

<h4> Objective: </h4>
<P> Create a management system facilitating seamless operations. </p>
